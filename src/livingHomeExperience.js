...
@keyframes sakinahHomeGlow{0%,100%{transform:translate3d(-14%,0,0);opacity:.28}50%{transform:translate3d(14%,0,0);opacity:.48}}
.sakinah-daily-stream{margin:-2px 0 22px;display:grid;gap:10px;animation:sakinahHomeRise .65s cubic-bezier(.2,.7,.2,1) both}
.sakinah-daily-hero{position:relative;overflow:hidden;border-radius:28px;padding:20px;background:linear-gradient(145deg,#173B57,#102C40);color:#fff;box-shadow:0 20px 42px rgba(23,59,87,.14)}
.sakinah-daily-hero:before{content:"";position:absolute;width:70%;height:180%;top:-40%;right:-20%;border-radius:50%;background:radial-gradient(circle,rgba(225,195,122,.24),transparent 68%);animation:sakinahHomeGlow 8s ease-in-out infinite}
.sakinah-daily-kicker{position:relative;font-size:10px;letter-spacing:.08em;color:#E2C984;opacity:.92}
.sakinah-daily-title{position:relative;font-family:Fraunces,'Noto Naskh Arabic',serif;font-size:25px;margin-top:7px}
.sakinah-daily-quote{position:relative;font-size:17px;line-height:1.95;margin-top:17px;max-width:520px}
.sakinah-daily-source{position:relative;font-size:9.5px;opacity:.48;margin-top:8px}
...
@media(max-width:430px){.sakinah-daily-row{grid-template-columns:1fr}.sakinah-daily-card{min-height:108px}.sakinah-daily-quote{font-size:16px}.sakinah-daily-hero{padding:18px;border-radius:24px}}
