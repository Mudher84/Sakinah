...
.sakinah-daily-row{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:10px}
.sakinah-daily-card{border:1px solid rgba(16,16,15,.065);border-radius:22px;padding:15px;background:rgba(255,255,255,.62);box-shadow:0 10px 28px rgba(16,16,15,.04);min-height:126px;position:relative;overflow:hidden;text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:center;min-width:0}
.sakinah-daily-card svg{width:22px;height:22px;color:#B59A62}.sakinah-daily-label{font-size:9px;opacity:.42;margin-top:12px;text-align:center}.sakinah-daily-card b{display:block;width:100%;font-size:12.5px;font-weight:550;line-height:1.75;margin-top:7px;text-align:center;overflow-wrap:anywhere}
...
@media(max-width:430px){.sakinah-daily-row{grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:8px}.sakinah-daily-card{min-height:122px;padding:12px 9px;border-radius:20px}.sakinah-daily-card b{font-size:11.5px;line-height:1.7}.sakinah-daily-label{font-size:8.5px;margin-top:9px}.sakinah-daily-card svg{width:20px;height:20px}.sakinah-daily-quote{font-size:15.5px}.sakinah-daily-hero{padding:16px;border-radius:22px;min-height:138px}}
