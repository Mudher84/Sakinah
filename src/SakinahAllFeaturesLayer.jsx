...
export default function SakinahAllFeaturesLayer({children}){
 ...
 const lang="ar";
 const open=to=>{if(CLOSE_ROUTES.has(to)){setFeature(null);return}if(to==="quran-home")to="quran-intelligence";if(to==="quran-search")to="islamic-search";if(to==="live-names")to="names-live";if(to==="dua-library")to="quranic-duas";setFeature(ALLOWED.has(to)?to:null)};
