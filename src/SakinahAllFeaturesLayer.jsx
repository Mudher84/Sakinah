...
export default function SakinahAllFeaturesLayer({children}){
 ...
 const go=to=>{
  ...
  if(to==="quran-home"){setFeature("quran-intelligence");return}
  if(to==="live-names"){setFeature("names-live");return}
  if(to==="dua-library"){setFeature("quranic-duas");return}
  if(to==="tafsir-library"){setFeature("quran-intelligence");return}
