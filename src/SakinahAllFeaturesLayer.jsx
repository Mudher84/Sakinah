...
import {LiveNamesOfAllah,NineBooksHub} from "./verifiedIslamic.jsx";
...
export default function SakinahAllFeaturesLayer(){
 const [feature,setFeature]=useState(null);
 const lang="ar";
 useEffect(()=>{
  const h=e=>setFeature(e.detail||null);
 ...
 const screens={
  ...
  "quran-player":<LiveQuranAudio lang={lang} go={go}/>,
  "nine-books":<NineBooksHub lang={lang} go={go}/>,
 };
 return <div style={{minHeight:"100vh"}}>{feature?(screens[feature]||<SakinahSevenDock/>):<SakinahSevenDock/>}</div>;
}
