...
export function DailyReflection({lang,go}){
 ...
 return <div style={{position:"absolute",inset:0,background:C.ivory,color:C.ink,overflowY:"auto",padding:"26px 16px 145px",boxSizing:"border-box"}} dir={lang==="ar"?"rtl":"ltr"}>
