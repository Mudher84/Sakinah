...
function ensureStyles(){
 ...
 #${BRAND_ID}{position:absolute!important;left:50%!important;top:50%!important;transform:translate(-50%,-50%)!important;margin:0!important;pointer-events:none!important;user-select:none!important;font-family:Georgia,'Times New Roman',serif!important;font-size:10px!important;font-weight:700!important;letter-spacing:.7px!important;line-height:1!important;color:#B43B35!important;text-transform:none!important;white-space:nowrap!important}
...
function ensureBar(){
 ...
 bar.setAttribute('aria-label','شريط مِرْآةُ الْمُسْلِمِ');
 const brand=document.createElement('div');
 brand.id=BRAND_ID;
 brand.textContent='Muslim Mirror';
 ...
 bar.appendChild(brand);bar.appendChild(b);document.body.appendChild(bar);return bar;
}
function reconcile(){
 ...
 if(feature||activeTarget)globalBack.classList.remove(HIDDEN_CLASS);else globalBack.classList.add(HIDDEN_CLASS);
}
