...
export function KidsWorldHub({lang="ar",go}){
 ...
 return <Shell lang={lang} go={go} back="profiles-center" titleAr="عالم سكينة الصغير" titleEn="Sakinah Kids" subAr="تعلم، اقرأ، استمع والعب في مساحة طفولية هادئة وآمنة" subEn="Learn, read, listen and play in a calm child-friendly space">
  <div style={{marginTop:18,borderRadius:30,padding:"20px 18px",background:"linear-gradient(135deg,#FFF0C9,#DFF6FF 58%,#F3E7FF)",position:"relative",overflow:"hidden"}}><div style={{position:"absolute",left:16,top:12,fontSize:26}}>☁️</div><div style={{position:"absolute",right:18,bottom:10,fontSize:24}}>⭐</div><div style={{fontSize:11,opacity:.55}}>مرحباً يا بطل ✨</div><div style={{fontSize:25,fontWeight:800,lineHeight:1.55,marginTop:5}}>ماذا تحب أن نكتشف اليوم؟</div><div style={{fontSize:11.5,opacity:.55,marginTop:5}}>اختر مغامرتك الصغيرة وابدأ من المكان الذي تحبه.</div></div>
