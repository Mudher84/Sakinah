...
export function installAdhanMomentScreenV2(){window.addEventListener("sakinah:adhan-start",e=>render(e.detail||{}));window.addEventListener("sakinah:adhan-preview",e=>render(e.detail||{prayer:"maghrib"}));window.sakinahPreviewAdhan=(prayer="maghrib")=>render({prayer});tick();setInterval(tick,15000)}
